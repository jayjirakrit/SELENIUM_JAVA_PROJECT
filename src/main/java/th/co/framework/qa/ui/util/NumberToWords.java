...
//    private static final String[] DIGIT_TH = {"ศูนย์", "หนึ่ง", "สอง", "สาม", "สี่", "ห้า", "หก", "เจ็ด", "แปด", "เก้า"};
    ...
    private static final String[] DIGIT_TH = { "Zero","One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine"};
    ...
    public String getTextFromNumber(String amount) {
        for (String element : DIGIT_TH) {
